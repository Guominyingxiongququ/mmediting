...
class EDVRDN(BasicRestorer):
    ...
    def test_big_size_raw(self, input_data, patch_h = 256, patch_w = 256, patch_h_overlap = 64, patch_w_overlap = 64):
    ...
    def forward_test(self,
        ...
        patch_h_overlap = 64
        patch_w_overlap = 64
        output = self.test_big_size_raw(lq, patch_h, patch_w, patch_h_overlap, patch_w_overlap)
        # lq shape n, t, c, h, w
        # gt shape n, c, h, w
        print(self.test_cfg)
